...
BAG_ROOT="$HOME/Documents/ese6510/ese651_project/rosbags"
...
echo "--- Lap times ---"
python3 bin/lap_time.py "$BAG_PATH" "$NAMESPACE" "$NUM_LAPS"
echo

echo "--- Full analysis (plots) ---"
python3 bin/process_bag_with_br_pos_export.py "$BAG_PATH" "$NAMESPACE"
